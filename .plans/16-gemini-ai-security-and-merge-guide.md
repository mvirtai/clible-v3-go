...
2. **Backend-suojaus**: Pyynnöt saapuvat palvelimen [main.go](file:///home/vivaldev/code/clible-v3-go/backend/main.go) -tiedostoon, jossa ne ohjataan kahden väliohjelman läpi:
   ...
   - `aiRateLimit`: Rajoittaa IP-kohtaiset kutsut arvoon 5 kutsua / minuutti.
...
* **IP-kohtainen rajoitin**: `/api/ai/*` -reitit on suojattu `middleware.NewIPRateLimiter(rate.Limit(5.0/60.0), 2)` -rajoittimella. Tämä tarkoittaa, että yksittäinen IP-osoite voi tehdä enintään 5 kutsua minuutissa (sallien lyhyen 2 kutsun purskeen).
