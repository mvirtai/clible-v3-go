# Vaihe 5B: Terraform main.tf ja outputs.tf

Tämä tiedosto opastaa luomaan Terraformin pääkonfiguraation ja tulostiedostot GCP-resursseja varten.

---

## 1. main.tf -tiedoston luominen

Luo tiedosto [main.tf](file:///home/vivaldev/code/clible-v3-go/terraform/main.tf) ja aseta sen sisällöksi seuraava koodi:
...
## 2. outputs.tf -tiedoston luominen

Luo tiedosto [outputs.tf](file:///home/vivaldev/code/clible-v3-go/terraform/outputs.tf) ja aseta sinne seuraava sisältö. Tämä tiedosto auttaa meitä saamaan tarvittavat URL-osoitteet heti deploymentin jälkeen.
