...
The direct interface to the database (supporting PostgreSQL and SQLite).
...
| **Repositories** | Models, Database (`*sql.DB`) | Services, API Handlers, Parser, Network I/O |
