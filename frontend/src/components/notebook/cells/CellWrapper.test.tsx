...
describe('CellWrapper', () => {
  ...
  it('renders cell content, percentage badge, drag handle, and resize handle', () => {
    ...
    const resizeHandle = container?.querySelector('[title*="Vedä muuttaaksesi"], [title*="Drag to resize"]');
  ...
  it('handles pointer down on resize handle without throwing errors', () => {
    ...
    const resizeHandle = container?.querySelector('[title*="Vedä muuttaaksesi"], [title*="Drag to resize"]') as HTMLDivElement;
    expect(resizeHandle).not.toBeNull();
